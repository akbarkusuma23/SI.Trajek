...
<body>
	...
	<div class="page-top-info" style="margin-bottom: 0px">
		<div class="container">
			<h4 style="font-size: 25pt">Tentang Kami</h4>
			</div>
		</div>
	<!-- Page info end -->
	...
	<section class="cart-section-spad" style="padding: 0px 50px 0px; margin: 50px 0px">
		<div class="cart-table">
			<h4 style="padding-bottom: 30px; font-size: 20pt; padding-left: 30px">TrajekLine</h4>
			<div class="row">

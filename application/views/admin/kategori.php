                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form action="<?= base_url('admin/cariKategori'); ?>" method="post">
                                <div class="input-group mb-3 mr-4 col-lg-6">
                                ...
                                <tbody>
                                    <?php foreach ($kategori as $kt) : ?>
                                        <tr>
                                            ...
                                            <td><?= $kt['kategori']; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/editkategori/' . $kt['id_kategori']); ?>" class="badge badge-success">edit</a>
                                                <a onclick="return confirm(`Anda ingin hapus?`)" href="<?= base_url('admin/hapuskategori/' . $kt['id_kategori']); ?>" class="badge badge-danger">hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>

                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($barang as $b) : ?>
                                        <tr>
                                            ...
                                            <td><?= $b['status']; ?></td>
                                            <td>
                                                <a href="<?= base_url('admin/editbarang/' . $b['id_barang']); ?>" class=" badge badge-success">edit</a>
                                                <a onclick="return confirm(`Anda ingin hapus?`)" href="<?= base_url('admin/hapusbarang/' . $b['id_barang']); ?>" class=" badge badge-danger">hapus</a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url('admin/barang'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="kapasitas" name="kapasitas" placeholder="Kapasitas">

                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($kwn as $k) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/editkaryawan/' . $k['nip']); ?>" class=" badge badge-success">edit</a>
                                                <a onclick="return confirm(`Anda ingin hapus?`)" href="<?= base_url('admin/hapuskaryawan/' . $k['nip']); ?>" class=" badge badge-danger">hapus</a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
